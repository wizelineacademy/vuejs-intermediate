  ...
  <div>
      ...
      <div class="container m-auto flex flex-col md:flex-row max-w-xl">
        <div class="flex flex-col w-full lg:w-1/2 justify-center items-start py-8">
          ...
          <p class="leading-normal mb-4">
            ...
            incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, ex ea commodo
            consequat. Sed ut perspiciatis unde omnis iste natus error sit voluptatem accusantium
            natus error sit.
          </p>
          <button
            class="bg-transparent hover:bg-black text-black font-semibold
    ...
    <form class="font-sans text-sm rounded w-full max-w-md mx-auto my-8 px-8 pt-6 pb-8">
      ...
      <div class="flex items-center justify-between">
        ...
        <a class="inline-block align-baseline text-gray-500 hover:text-gray-700" href="#">
          Forgot Password?
        </a>
      </div>
    </form>
